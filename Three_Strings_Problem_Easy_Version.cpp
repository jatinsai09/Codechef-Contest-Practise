...
int main() {
    ...
    while (tc--) {
        ...
        ll a_1_10 = m1[1], a_1_01 = m1[-1];
        ll a_0_10 = m2[1], a_0_01 = m2[-1];

        {
            if (a_1_10 + a_1_01 == 0) {
                cout << abs(a_0_10 - a_0_01) << nl;
                continue;
            }
            if (a_0_10 + a_0_01 == 0) {
                cout << abs(a_1_10 - a_1_01) << nl;
                continue;
            }
        }
        ...
        {
            if (a_1_10 && a_0_01) {
                cout << max(a_1_10, a_0_01) << nl;
                continue;
            }
            if (a_0_10 && a_1_01) {
                cout << max(a_0_10, a_1_01) << nl;
                continue;
            }
        }

        cout << a_0_10 + a_0_01 + a_1_01 + a_1_10 << nl;
